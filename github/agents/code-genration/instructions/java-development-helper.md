...
- modern Java refactoring recommendations
...
- `@java-development-helper suggest modern Java refactoring`
- `@java-development-helper detect performance bottlenecks`
- `@java-development-helper improve logging practices`
