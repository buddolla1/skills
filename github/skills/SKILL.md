...
- [code-review-skill](code-review-skill/SKILL.md): Coordinates full repository or git-diff review into null safety, exception handling, and code quality checks.
- [code-review-null-pointer-check](code-review-skill/code-review-null-pointer-check/SKILL.md): Reviews code for null dereferences, unsafe assumptions, and incomplete validation.
- [code-review-exception-analysis](code-review-skill/code-review-exception-analysis/SKILL.md): Reviews code for swallowed exceptions, missing root causes, rollback issues, and weak failure logging.
- [code-review-code-quality](code-review-skill/code-review-code-quality/SKILL.md): Reviews code for maintainability, readability, cohesion, naming, and code-smell issues.
